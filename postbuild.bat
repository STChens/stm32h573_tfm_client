...
set provisioningdir="%projectdir%\Provisioning"
...
::image binary files
::=============================================================================================
set s_code_bin=%tfm_s%
set ns_code_bin="%projectdir%\Binary\tf-m-test.bin"
set one_code_bin="%projectdir%\Binary\rot_tz_app.bin"

::=============================================================================================
::image xml configuration files
::=============================================================================================
set s_code_xml="%provisioningdir%\Images\%project%_S_Code_Image.xml"
set ns_code_xml="%provisioningdir%\Images\%project%_NS_Code_Image.xml"
set s_code_init_xml="%provisioningdir%\Images\%project%_S_Code_Init_Image.xml"
set ns_code_init_xml="%provisioningdir%\Images\%project%_NS_Code_Init_Image.xml"
set s_data_xml="%provisioningdir%\Images\%project%_S_Data_Image.xml"
set ns_data_xml="%provisioningdir%\Images\%project%_NS_Data_Image.xml"
set s_data_init_xml="%provisioningdir%\Images\%project%_S_Data_Init_Image.xml"
set ns_data_init_xml="%provisioningdir%\Images\%project%_NS_Data_Init_Image.xml"
...
set s_app_bin_xml_field=%s_code_bin%
set ns_app_bin_xml_field=%ns_code_bin%
